...
| WP2 | Integración end-to-end en Docker contra Odoo | ✓ Completado |
...
| WP | Descripción | Estado |
|---|---|---|
| WP1 | Yamaha multi-PDF — auto-detección de engine_model desde página 1 | Pendiente |
| WP2 | Volvo multi-motor — navegación dinámica de categorías | Pendiente |
